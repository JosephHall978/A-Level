...
def instructions(screen, width,height):#function used to draw instructions menu
    ...
    draw_text_left(screen, "Controllers not supported yet", 20, width//14, 180,yellow)#draws relevant text of on display using function draw_text_left
    draw_text_left(screen, "Music:", 20, width//20, 210,yellow)#draws relevant text of on display using function draw_text_mid
    draw_text_left(screen, "Open the music menu from the main menu", 20, width//14, 240,yellow)#draws relevant text of on display using function draw_text_left
    draw_text_left(screen, "Change Option using up and down key", 20, width//14, 270,yellow)#draws relevant text of on display using function draw_text_left
    draw_text_left(screen, "You can also use 'W' and 'S'", 20, width//14, 300,yellow)#draws relevant text of on display using function draw_text_left
    rock = str(pathlib.Path.cwd().joinpath('img','rock small.png'))
